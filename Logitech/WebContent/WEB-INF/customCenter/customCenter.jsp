...
input[id*="answer"] + label em {
	...
	background:url('./img/arrow.png') 0 0 norepeat;
...
<div class="c_container">
	...
	<div class="item item2">
		...
		<div id="header">
			...
			<br> <br>
				...
				<div class="faq-tab">
					...
					<div class="tab">
						<ul class="ct">
							<li class="active"><a href="javascript:;"><span>전체보기</span></a>
							<!--  span class="blind">현재위치</span>--></li>
							<li><a href="javascript:;" id="cate"
								data-cmn_com_up_idx="2201"><span>회원가입/탈퇴</span></a></li>
							<li><a href="javascript:;" id="cate"
								data-cmn_com_up_idx="2202"><span>회원정보</span></a></li>
							<li><a href="javascript:;" id="cate"
								data-cmn_com_up_idx="2204"><span>통합 멤버십</span></a></li>
						</ul>
					</div>
				</div>
		...
		<%-- 
			<h3>FAQ 검색결과 <span style="color:red;" >${searchResult}</span> 건</h3>
		<c:forEach var="faqvo" items="${faqList}" varStatus="status">
		
			<div class="accordion">
				<input type="radio" name="accordion" id="answer0${status.count}"> <label
					for="answer0${status.count}">					
					
						<span><i class="glyphicon glyphicon-search"></i></span>
						<span>${faqvo.suq_category}</span>

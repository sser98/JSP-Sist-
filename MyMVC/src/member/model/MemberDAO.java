...
public class MemberDAO implements InterMemberDAO {
	...
	public MemberVO selectOneMember(Map<String, String> paraMap) throws SQLException {
		...
		try {
			...
			if(paraMap.get("snstype") == null) {
			
				sql = "SELECT userid, name, email, mobile, postcode, address, detailaddress, extraaddress, gender, "+
			...
			else if("kakao".equals(paraMap.get("snstype"))) {
